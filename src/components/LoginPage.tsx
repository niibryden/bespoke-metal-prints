    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes('provider is not enabled') || error.message.includes('Unsupported provider')) {
          throw new Error('Google sign-in is not configured yet. Please use email/password to sign in or contact support.');
        }
        throw error;
      }
    } catch (err: any) {
        ...
        <div className="p-6">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white dark:bg-[#1a1a1a] text-gray-500">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white text-black rounded-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg text-xs text-blue-400">
            <strong>Note:</strong> Google sign-in requires configuration in Supabase. Follow the{' '}
            <a
