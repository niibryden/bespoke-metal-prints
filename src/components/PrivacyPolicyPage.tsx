        ...
        >
          ...
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl text-black dark:text-white mb-4">Information We Collect</h2>
                <div className="space-y-6 text-gray-700 dark:text-gray-300">
                  <div>
                    <h3 className="text-lg text-black dark:text-white mb-3">Personal Information</h3>
                  ...
                  <div>
                    <h3 className="text-lg text-black dark:text-white mb-3">Images and Content</h3>
                  ...
                  <div>
                    <h3 className="text-lg text-black dark:text-white mb-3">Automatically Collected Information</h3>
                    <p className="mb-3 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg text-black dark:text-white mb-3">Cookies and Tracking</h3>
                    <p className="leading-relaxed">
          ...
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl text-black dark:text-white mb-4">How We Use Your Information</h2>
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  <p className="leading-relaxed">We use the information we collect to:</p>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="bg-[#0a0a0a] p-4 rounded-lg border border-[#ff6b35]/10 dark:bg-white">
                      <h3 className="text-white mb-2 dark:text-black">Order Processing</h3>
                      <p className="text-sm">Process and fulfill your orders, including printing, shipping, and customer support</p>
                    </div>
                    <div className="bg-[#0a0a0a] p-4 rounded-lg border border-[#ff6b35]/10 dark:bg-white">
                      <h3 className="text-white mb-2 dark:text-black">Communication</h3>
                      <p className="text-sm">Send order confirmations, shipping updates, and respond to inquiries</p>
                    </div>
                    <div className="bg-[#0a0a0a] p-4 rounded-lg border border-[#ff6b35]/10 dark:bg-white">
                      <h3 className="text-white mb-2 dark:text-black">Account Management</h3>
                      <p className="text-sm">Maintain your account, order history, and saved preferences</p>
                    </div>
                    <div className="bg-[#0a0a0a] p-4 rounded-lg border border-[#ff6b35]/10 dark:bg-white">
                      <h3 className="text-white mb-2 dark:text-black">Site Improvement</h3>
                      <p className="text-sm">Analyze usage patterns to improve our website and services</p>
                    </div>
                    <div className="bg-[#0a0a0a] p-4 rounded-lg border border-[#ff6b35]/10 dark:bg-white">
                      <h3 className="text-white mb-2 dark:text-black">Marketing</h3>
                      <p className="text-sm">Send promotional emails (only with your consent - you can opt out anytime)</p>
                    </div>
                    <div className="bg-[#0a0a0a] p-4 rounded-lg border border-[#ff6b35]/10 dark:bg-white">
                      <h3 className="text-white mb-2 dark:text-black">Legal Compliance</h3>
          ...
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl text-black dark:text-white mb-4">Information Sharing and Disclosure</h2>
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  <p className="leading-relaxed">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-white mb-2 dark:text-black">Service Providers</h3>
                    ...
                    <div>
                      <h3 className="text-white mb-2 dark:text-black">Legal Requirements</h3>
                      <p className="text-sm leading-relaxed">
                    ...
                    <div>
                      <h3 className="text-white mb-2 dark:text-black">Business Transfers</h3>
                      <p className="text-sm leading-relaxed">
                    ...
                    <div>
                      <h3 className="text-white mb-2 dark:text-black">With Your Consent</h3>
                      <p className="text-sm leading-relaxed">
          ...
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl text-black dark:text-white mb-4">SMS Communications</h2>
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  <p className="leading-relaxed">
                  ...
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <span><strong className="text-black dark:text-white">Message frequency varies</strong> based on your order activity</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <span><strong className="text-black dark:text-white">Message and data rates may apply</strong> depending on your mobile carrier</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <span>You may <strong className="text-black dark:text-white">opt out at any time by replying STOP</strong> to any SMS message</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <span>Request assistance by <strong className="text-black dark:text-white">replying HELP</strong> to any SMS message</span>
                    </li>
                  </ul>
          ...
          {/* Data Security */}
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <h2 className="text-2xl text-black dark:text-white mb-4">Data Security</h2>
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p className="leading-relaxed">
          ...
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl text-black dark:text-white mb-4">Your Privacy Rights</h2>
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="space-y-3 ml-4">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h3 className="text-white mb-1 dark:text-black">Right to Access</h3>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h3 className="text-white mb-1 dark:text-black">Right to Correction</h3>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h3 className="text-white mb-1 dark:text-black">Right to Deletion</h3>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h3 className="text-white mb-1 dark:text-black">Right to Opt-Out</h3>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-[#ff6b35] rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <h3 className="text-white mb-1 dark:text-black">Right to Data Portability</h3>
          ...
          {/* Data Retention */}
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <h2 className="text-2xl text-black dark:text-white mb-4">Data Retention</h2>
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p className="leading-relaxed">
          ...
          {/* Children's Privacy */}
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <h2 className="text-2xl text-black dark:text-white mb-4">Children's Privacy</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          {/* International Users */}
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <h2 className="text-2xl text-black dark:text-white mb-4">International Data Transfers</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          {/* Updates */}
          <section className="bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-8 border border-gray-200 dark:border-[#ff6b35]/20">
            <h2 className="text-2xl text-black dark:text-white mb-4">Changes to This Policy</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="bg-gradient-to-r from-[#ff6b35]/10 to-[#ff8c42]/10 rounded-2xl p-8 border border-[#ff6b35]/30 text-center">
            <h2 className="text-2xl text-black dark:text-white mb-4">Contact Us About Privacy</h2>
